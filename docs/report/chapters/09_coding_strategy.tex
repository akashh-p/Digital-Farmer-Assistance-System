\subsection{Programming Language environment}
...
\begingroup\footnotesize\begin{tabular}{>{\bfseries}p{3cm} p{10cm}}
\toprule
...
\subsection{Project Architecture Structure}
...
\subsection{Representative Implementation Code}
...
\begin{lstlisting}[language=Java, caption={Implementation of Farmer Authentication Protocol}]
